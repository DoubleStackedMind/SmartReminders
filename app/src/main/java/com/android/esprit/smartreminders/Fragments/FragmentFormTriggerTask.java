...
public class FragmentFormTriggerTask extends FragmentChild implements TimePickerDialog.OnTimeSetListener, View.OnClickListener  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_form_triggertask, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        initViews();
        defineBehaviour();
        mNotificationHelper = new NotificationHelper(FragmentFormTriggerTask.this.ParentActivity);
    }
    ...
    private void initViews() {
        ...
        TriggerTask = this.ParentActivity.findViewById(R.id.TriggerTask);
    ...
    private void defineBehaviour() {
        ...
        TriggerTask.setOnClickListener(view -> selectTriggers());
        checkedItems = new boolean[vals.length];
    }

    private void selectTriggers() {
        mBuilder = new AlertDialog.Builder(this.ParentActivity);
        mBuilder.setTitle("Select Triggers you Want to Execute");
        String[] vals = new String[ActionPool.getInstance(this.ParentActivity).getActions().length];
        Arrays.stream(ActionPool.getInstance(this.ParentActivity).getActions()).map(Action::getName).collect(Collectors.toList()).toArray(vals);
        ...
        mBuilder.setMultiChoiceItems(vals, checkedItems, (DialogInterface.OnMultiChoiceClickListener) (dialogInterface, position, isChecked) -> {
            Action a = ActionPool.getInstance(FragmentFormTriggerTask.this.ParentActivity).getActions()[position];
            if (isChecked) {
